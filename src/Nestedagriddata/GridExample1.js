import React, {
  ...
  const groupData=[ 
    ...
    {
        orgHierarchy:['Panther Lake P Platform Segment','Panther Lake P Premium Notebook' ],
    ...
    {
        orgHierarchy:['Panther Lake P Platform Segment','Panther Lake P Premium Notebook','Panther Lake Window System'],
    ...
    {
        orgHierarchy:['Panther Lake P Platform Segment','Panther Lake P Premium Notebook','Panther Lake P Linux System Software'],
        itemType:"Product Variant",
       testName:"Test details",
       source:"",
       testCategory:"",
    ...
    {
        orgHierarchy:['Panther Lake P Platform Segment','Panther Lake P Hybrid FGPA'],
        itemType:"Product Variant",
       testName:"",
       source:"",
       testCategory:"",
    ...
    {
        orgHierarchy:['Panther Lake P Platform Segment','Panther Lake P Hybrid FGPA','Panther Lake P Hybrid FGPA'],
        itemType:"Product Variant",
       testName:"Test details",
       source:"",
       testCategory:"",
