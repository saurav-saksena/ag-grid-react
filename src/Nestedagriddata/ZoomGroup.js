...
import { rowData12, columnDefs12 } from "./zoomData";
  ...
  const NestedTreeGrouping = () => {
    ...
    const defaultColDef = {resizable:true,floatingFilter:true,filter:"agTextColumnFilter",filterParams: { newRowsAction: 'keep' },cellHeight:15}
    ...
    const autoGroupColumnDefs = useMemo(() => [
        {
          ...
          valueGetter: (params) => {
            ...
            return `${params.data.orgHierarchy[params.data.orgHierarchy.length - 1]}`;
          },
        },
        {
          headerName: "Test",
