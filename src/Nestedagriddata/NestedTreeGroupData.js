  ...
  { headerName: "Test Category", field: "testCategory" },
  {
    ...
    cellRenderer: (params) => {
      if (params.value === "Pass") {
        return (
          <span>
            <i className="bi bi-check-circle bg-success text-light p-1 rounded-1"></i>{" "}
            {params.value}
          </span>
        );
        ...
        return (
          <span>
            <i className="bi bi-x-circle bg-danger text-light p-1 rounded-1"></i>{" "}
            {params.value}
          </span>
        );
      } else {
...
export const groupDataTree = [
  ...
  },
  {
    orgHierarchy: [
      ...
      "Panther Lake P Premium Notebook Clamshell Convertible",
    ],
