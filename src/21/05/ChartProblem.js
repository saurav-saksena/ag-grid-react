...
const GridWithChart = () => {
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    {headerName:"Data Completeness", field: "dataComplete",width:170, pinned: 'left',hide:true,
    cellRenderer: (params) => {
      if(params.value){

        return <a style={{textDecoration:"none"}} href="https://www.ag-grid.com/react-data-grid/excel-export-hyperlinks/" target="_blank" rel="noreferrer"> {params.value} </a>
      }else{
        return ""
      }
    },
  ...
  {headerName:"3rd Party Compliance", field: "thirdParty" ,hide:true, cellRenderer: (params) => {
    if(params.value){
  ...
  cellRenderer: function(params) {
    ...
    return <a className='hyper--cell' href={"https://www.ag-grid.com/react-data-grid/excel-export-hyperlinks/"+params.data.id} target="_blank" rel="noreferrer"> {params.value} </a>
              }},
  ...
  return (
    <div>
      ...
      <div className="wrapper">
        ...
        <div id="myChart" className="ag-theme-alpine" style={{height:500,width:300,margin:"auto"}}></div>
      </div>
    </div>
  );
};
